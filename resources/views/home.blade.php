...
<div class="container">
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            <a class="btn btn-lg btn-block btn-primary" href="{{ route('libros.index') }}">Libros Disponibles</a>
            <a class="btn btn-lg btn-block btn-outline-primary" href="{{ route('prestamos.index') }}">Reserva tu libro</a>
        </div>
        <div class="col 12 col-lg-6">
