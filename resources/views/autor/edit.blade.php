        ...
        <div class="col-md-6">
            <form method="POST" action="{{ route('autor.update', $autor) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror " value="{{ old('nombre', $autor->nombre) }}">
                    {!! $errors->first('nombre', '<small>:message</small><br>') !!}
                </div>
                <div class="form-group">
                    <label for="nacionalidad">Nacionalidad</label>
                    <select class="form-control @error('nacionalidad') is-invalid @enderror" name="nacionalidad">
                        <option value="{{ $autor->nacionalidad }}">{{ $autor->nacionalidad }}</option>
