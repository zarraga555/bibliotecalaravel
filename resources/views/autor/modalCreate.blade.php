    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Crear Nuevo Autor</h5>
            ...
            <div class="modal-body">
                <form id="FormCreate">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('nacionalidad') is-invalid @enderror" id="nacionalidad" name="nacionalidad">
