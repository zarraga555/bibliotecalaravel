...
@section('formulario')
    <div class="col">
        ...
        <h1>@lang('Editar Editorial')</h1><br>
        {{-- @if ($errors->any())
    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            <form method="POST" action="{{ route('editorial.update', $editorial) }}">
                @csrf @method('PATCH')
                <div class="form-group">
                    <label for="nombre">Nombre de la Editorial</label>
                    <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror " value="{{ old('nombre', $editorial->nombre) }}">
