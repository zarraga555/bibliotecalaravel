    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar Bibliotecario</h5>
                ...
                <form >
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" name="ci" id="ciedit" class="form-control @error('ci') is-invalid @enderror " value="{{ old('ci') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('turno') is-invalid @enderror" name="turno" id="turnoedit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fechaNacimiento" id="fechaNacimientoedit" class="form-control @error('fechaNacimiento') is-invalid @enderror" value="">
                        {!! $errors->first('fechaNacimiento', '<small>:message</small><br>') !!}
                    </div>
                    <div class="form-group">
                        <label for="paisNacimiento">Nacionalidad</label>
                        <select class="form-control @error('paisNacimiento') is-invalid @enderror" name="paisNacimiento" id="paisNacimientoedit">
                            <option value="">Selecciona una opcion</option>
