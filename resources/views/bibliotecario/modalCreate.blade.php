    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Crear Bibliotecario</h5>
            ...
            <div class="modal-body">
                <form id="FormCreate">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fechaNacimiento" id="fechaNacimiento" class="form-control @error('fechaNacimiento') is-invalid @enderror" value="">
                        {!! $errors->first('fechaNacimiento', '<small>:message</small><br>') !!}
                    </div>
                    <div class="form-group">
                        <label for="paisNacimiento">Nacionalidad</label>
                        <select class="form-control @error('paisNacimiento') is-invalid @enderror" name="paisNacimiento" id="paisNacimiento">
                            <option value="">Selecciona una opcion</option>
