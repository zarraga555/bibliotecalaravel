                ...
                <form>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" name="ci" id="ciShow" class="form-control @error('ci') is-invalid @enderror " value="{{ old('ci') }}" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('turno') is-invalid @enderror" name="turno" id="turnoShow" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="salario" id="salarioShow" class="form-control @error('salario') is-invalid @enderror" value="{{ old('salario')}}" disabled>
                        {!! $errors->first('salario', '<small>:message</small><br>') !!}
                    </div>
                    <div class="form-group">
                        <label for="fechaNacimiento">Fecha de Nacimiento</label>
                        <input type="date" name="fechaNacimiento" id="fechaNacimientoShow" class="form-control @error('fechaNacimiento') is-invalid @enderror" value="" disabled>
                        {!! $errors->first('fechaNacimiento', '<small>:message</small><br>') !!}
                    </div>
                    <div class="form-group">
                        <label for="paisNacimiento">Nacionalidad</label>
                        <select class="form-control @error('paisNacimiento') is-invalid @enderror" name="paisNacimiento" id="paisNacimientoShow" disabled>
                            <option value="">Selecciona una opcion</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('sexo') is-invalid @enderror" name="sexo" id="sexoShow" disabled>
                            <option value="">Selecciona una opcion</option>
